...
window.onload = function () {
  ...
  gunting[0].addEventListener("click", function () {
    ...
    userSelect.innerHTML =
      "<p>User</p> <img src='img2/gunting1-08.png' width='120'>";
    if (compNumb == 1) {
      versus.innerHTML = "<img src='img2/versus.png'>";
      computerSelect.innerHTML =
        "<p>Computer</p><img src='img2/gunting2-09.png' width='170'>";
      tampilScoreUser.innerHTML = "User = " + scoreUser;
      tampilScoreComputer.innerHTML = "Computer = " + scoreComputer;
    } else if (compNumb == 2) {
      versus.innerHTML = "<img src='img2/versus.png'>";
      computerSelect.innerHTML =
        "<p>Computer</p><img src='img2/kertas2-07.png'  width='150'>";
      scoreUser += 1;
      tampilScoreUser.innerHTML = "User = " + scoreUser;
      tampilScoreComputer.innerHTML = "Computer = " + scoreComputer;
    } else if (compNumb == 3) {
      versus.innerHTML = "<img src='img2/versus.png'>";
      computerSelect.innerHTML =
        "<p>Computer</p><img src='img2/batu2-05.png'  width='150'>";
      scoreComputer += 1;
      tampilScoreUser.innerHTML = "User = " + scoreUser;
      tampilScoreComputer.innerHTML = "Computer = " + scoreComputer;
    }
  ...
  kertas[0].addEventListener("click", function () {
    compNumb = randomChoose();
    userSelect.innerHTML =
      "<p>User</p> <img src='img2/kertas1-06.png'  width='120'>";
    if (compNumb == 1) {
      versus.innerHTML = "<img src='img2/versus.png'>";
      computerSelect.innerHTML =
        "<p>Computer</p> <img src='img2/gunting2-09.png'  width='150'>";
      scoreComputer += 1;
      tampilScoreUser.innerHTML = "User = " + scoreUser;
      tampilScoreComputer.innerHTML = "Computer = " + scoreComputer;
    } else if (compNumb == 2) {
  ...
  batu[0].addEventListener("click", function () {
    compNumb = randomChoose();
    userSelect.innerHTML =
      "<p>User</p> <img src='img2/batu1-04.png'  width='120'>";
    if (compNumb == 1) {
      versus.innerHTML = "<img src='img2/versus.png'>";
      computerSelect.innerHTML =
        "<p>Computer</p><img src='img2/gunting2-09.png'  width='150'>";
